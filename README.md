...
Binary classification project using Logistic Regression to identify underwater objects as rock or mine based on sonar signals.  
Includes data preprocessing, stratified train-test split, model training, and evaluation.
